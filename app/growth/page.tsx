...
const ATTRIBUTE_META: Record<string, {
  ...
  C: {
    short: 'C · 好奇心',
    title: 'Curiosity（好奇心）',
    description: '以強大的提問驅動深度學習，是探索者的啟動引擎。關鍵詞：閱讀、研究、學習、分析、提問、探索、課程、訪談、觀察、資料、好奇、聽、看、訪綱、問卷、使用者研究、勘查。'
  },
  R: {
    short: 'R · 韌性',
    title: 'Resilience（韌性）',
    description: '建立可持續的身心基礎，是自我成長的穩定器。關鍵詞：健身、運動、訓練、營養、睡眠、冥想、休息、復盤、反思、挑戰、日誌、週記、日記、心態、檢討、堅持。'
  },
  E: {
    short: 'E · 表達力',
    title: 'Expression（表達力）',
    description: '把內在價值與世界連結，是思想與受眾的溝通橋樑。關鍵詞：分享、敘事、演說、溝通、錄製、發表、文案、草稿、演講、對話、回覆、社群、寫、剪輯。'
  },
  A: {
    short: 'A · 行動力',
    title: 'Action（行動力）',
    description: '將抽象想法化成產出，是理想世界的建造者。關鍵詞：建構、執行、實作、開發、程式、Code、設計、製作、VibeCoding、原型、Prototype、部署、發佈、動手做。'
  },
  T: {
    short: 'T · 思考力',
    title: 'Thinking（思考力）',
    description: '連結跨域知識並創造框架，是知識的煉金術士。關鍵詞：整合、思考、規劃、大綱、整理、筆記、心智圖、框架、結構、策略、連結、分類、歸納、模型、假設、推演。'
  },
  EV: {
    short: 'EV · 進化力',
    title: 'Evolution（進化力）',
    description: '擁抱變化與迭代，是系統升級的首席架構師。關鍵詞：適應、優化、迭代、重構、學習新工具、自動化、流程、升級、更新、實驗、測試、Debug、效率。'
  }
}
